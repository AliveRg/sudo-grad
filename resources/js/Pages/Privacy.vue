<template>
    <div class="flex justify-center">
        <div
            class="w-[80vw] flex flex-col gap-8 z-10 bg-white shadow-lg rounded-lg p-6 justify-center overflow-y-scroll"
        >
            ...
            <p>
                ...
                предпринимаемые Городова Елена Николаевна (далее — Оператор).
                ...
                о посетителях веб-сайта https://stgorodova.ru/. 2. Основные
                ...
                сети интернет по сетевому адресу https://stgorodova.ru/. 2.4.
                ...
                или определяемому Пользователю веб-сайта https://stgorodova.ru/.
                ...
                веб-сайта https://stgorodova.ru/. 2.11. Предоставление
                ...
                7. Условия обработки персональных данных 7.1. Обработка
                персональных данных осуществляется с согласия субъекта
                персональных данных на обработку его персональных данных. 7.2.
                ...
                обязанностей. 7.3. Обработка персональных данных необходима для
                ...
                персональные данные). 7.7. Осуществляется обработка персональных
                данных, подлежащих опубликованию или обязательному раскрытию в
                соответствии с федеральным законом. 8. Порядок сбора, хранения,
                ...
                защиты персональных данных. 8.1. Оператор обеспечивает
                ...
                обязательств по гражданско-правовому договору. 8.3. В случае
                ...
                gorodova.work49280@gmail.com с пометкой «Актуализация
                персональных данных». 8.4. Срок обработки персональных данных
                ...
                электронный адрес Оператора gorodova.work49280@gmail.com с
                пометкой «Отзыв согласия на обработку персональных данных». 8.5.
                ...
                gorodova.work49280@gmail.com. 12.2. В данном документе будут
                ...
                https://stgorodova.ru/dashboard/contact.
            </p>
            <a
                class="px-8 py-4 bg-sky-500 w-fit inline-block rounded-2xl text-white"
                :href="route('contact')"
